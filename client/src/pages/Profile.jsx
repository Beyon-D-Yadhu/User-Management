...
const Profile = () => {
    ...
    try {
     ...
     if(isPasswordInputClicked){
      ...
      if (isPasswordValid(userdata.newpassword)) {
        console.log("New password check");
        valid = false;
        error.newpassword = true;
      ...
      if (valid) {
        ...
        // console.log('Image Response = ',await imgResponse)
        }
  ...
  return (
      <div className="bg-cover bg-no-repeat h-screen" >
      <Navbar />

      <div className="max-w-md mx-auto mt-16 bg-slate-50 rounded py-4">
